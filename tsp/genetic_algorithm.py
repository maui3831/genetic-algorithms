...
class GeneticAlgorithm:
    ...
    def order_crossover(self, parent1: Chromosome, parent2: Chromosome) -> Tuple[List[int], List[int]]:
        ...
        for generation in range(self.max_generations):
            ...
            while len(new_population) < self.population_size:
                ...
                if random.random() < self.crossover_prob:
                    ...
                    child1_route, child2_route = parent1.route.copy(), parent2.route.copy()
                ...
                if len(new_population) < self.population_size:
                    new_population.append(Chromosome(child2_route, self.distance_matrix))
            ...
            if generations_without_improvement >= stagnation_limit:
                print(f"Terminated after {generation + 1} generations due to no improvement for {stagnation_limit} generations")
                break
