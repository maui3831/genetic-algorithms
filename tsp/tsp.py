...
class TSPVisualizer:
    def __init__(self, width=1000, height=800):
        ...
        try:
            ...
            map_path = script_dir / "map.png"
            self.map_image = pygame.image.load(str(map_path))
                ...
                if event.type == pygame.QUIT:
                    ...
                    if event.key == pygame.K_r:
                        ...
                        if (
                            ...
                            < len(self.intermediate_solutions) - 1
                        ):
                            self.current_solution_index += 1
                            self.best_solution = self.intermediate_solutions[
                                self.current_solution_index
                            ]
                            self.generation = (
                                self.current_solution_index
